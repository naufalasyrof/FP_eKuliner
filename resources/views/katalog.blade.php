                                ...
                                <button type="submit" class="btn text-start btn-katalog">
                                        <div class="card card-h">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <input class="form-control" type="text" name="id_produk" id="id_produk"value="{{ $produks->id }}" placeholder="Enter Age" hidden>
                                            <input class="form-control" type="text" name="id_user" id="id_user" value="{{ auth()->id() }}" placeholder="Enter Age" hidden>
                                            <input class="form-control" type="text" name="harga" id="harga" value="{{ $produks->harga }}" placeholder="Enter Age" hidden>
                                            </div>
                                        </div>
                                    </button>
                            </form>
